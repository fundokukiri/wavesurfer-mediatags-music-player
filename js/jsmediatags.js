            ...
            (function (_MediaTagReader) {
              ...
              function FLACTagReader() {
                ...
                _this = _possibleConstructorReturn(
                  this,
                  (_getPrototypeOf2 =
                    _getPrototypeOf(FLACTagReader)).call.apply(
                    _getPrototypeOf2,
                    [this].concat(args)
                  )
                );
                ...
                },
                {
                  ...
                  value: function _readFrameHeader(data, offset, id3header) {
                    ...
                    switch (major) {
                      ...
                      case 4:
                        var frameId = data.getStringAt(offset, 4);
                        var frameSize = data.getSynchsafeInteger32At(
                          offset + 4
                        );
                        break;
                    }
                  ...
                  },
                  {
                    ...
                    value: function _parseData(data, tags) {
                      ...
                      if (xheader) {
                        ...
                        if (major === 4) {
                          var xheadersize =
                            data.getSynchsafeInteger32At(offset);
                          offset += xheadersize;
                        } else {
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function _roundRangeToChunkMultiple(range) {
                      ...
                      var newLength =
                        Math.ceil(length / CHUNK_SIZE) * CHUNK_SIZE;
